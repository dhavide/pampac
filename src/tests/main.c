...
void main(int argc, char* argv[])
{
  ...
  clone = new_PTnode();
  orig->N_dim = N;
  orig->z = malloc(N*sizeof(double)); orig->z[0]=1.7;
  orig->z_parent = malloc(N*sizeof(double)); orig->z_parent[1]=-3.2;
  orig->T_parent = malloc(N*sizeof(double)); orig->T_parent[2]=4.5;
